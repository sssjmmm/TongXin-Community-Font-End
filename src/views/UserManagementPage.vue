    ...
    <div>
        <div class="container">
            <div class="handle-box">
                <searchuser @search="performSearch"/>
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                ...
                <el-table-column prop="picture" label="图片内容" align="center">
                    <template #default="scope">
        ...
        <!-- <el-dialog title="编辑" v-model="editVisible" width="30%">
            <el-form label-width="100px">
                ...
                <el-form-item label="指定粉丝数量">
                    <el-select v-model="followedNumber" class="handle-select mr10">
                        <el-option key="1" label="不限" value="不限"></el-option>
                        <el-option key="7" label="不允许关注" value="不允许关注"></el-option>
